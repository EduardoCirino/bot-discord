...
export class DemoPermissionsCommand implements Command {
  ...
  permissions = {
    ...
    guildOnly: true,
    customCheck: async (interaction: ChatInputCommandInteraction) => {
...
export class UserLevelCommand implements Command {
  name = 'user-command';
...
export class RoleBasedCommand implements Command {
  name = 'role-command';
...
export class OwnerOnlyCommand implements Command {
  name = 'owner-command';
