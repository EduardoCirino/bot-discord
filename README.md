...
5. Fill in your bot credentials in `.env`:

   ```
   DISCORD_TOKEN=your_bot_token_here
   DISCORD_CLIENT_ID=your_client_id_here
   DISCORD_GUILD_ID=your_guild_id_here  # Optional
   DATABASE_URL=postgres://discord_user:discord_password@localhost:5432/discord_bot
   ```
...
- **DatabaseService**: PostgreSQL database operations using Drizzle ORM
...
The bot uses PostgreSQL with Drizzle ORM and the following tables:
...
- Access Adminer at http://localhost:8080 for database administration
